...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_firstName'), 'DemoFirstName')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_lastName'), 'DemoLaseName')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_postalCode'), 'DemoZipCode')

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Swag Labs/input_continue'))
