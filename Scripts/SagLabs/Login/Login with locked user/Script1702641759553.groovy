...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_user-name'), 'locked_user')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Swag Labs/input_password'), 'GziJh/CAJtdtPWzOU1eGAQ==')
